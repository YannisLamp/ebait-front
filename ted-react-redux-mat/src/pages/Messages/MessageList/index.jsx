                    ...
                    return (
                        <ExpansionPanel key={message.id}>
                            <ExpansionPanelSummary
                                ...
                                onClick={e => { markAsReadMessage(message.id) }}
                            // aria-controls="panel1a-content"
                            // id="panel1a-header"
                            >
                                <Typography className={classes.heading} style={!message.read ? { fontWeight: 'bold' } : ''}>{startLabel + nameLabel}</Typography>
                            </ExpansionPanelSummary>
